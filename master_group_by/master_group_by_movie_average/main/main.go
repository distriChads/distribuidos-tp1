...
import (
	...
	master_group_by "distribuidos-tp1/master_group_by/master_group_by_movie_average"
...
func main() {
	...
	outputRoutingKeysFirstLast := strings.Split(v.GetString("ROUTINGKEYS_OUTPUT_FIRST-AND-LAST"), ",")

	filterRoutingKeysMap := map[string][]string{
		"first_last": outputRoutingKeysFirstLast,
	}
