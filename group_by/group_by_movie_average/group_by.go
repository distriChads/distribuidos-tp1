...
func (g *GroupByMovieAndAvg) UpdateState(lines []string, client_id string, message_id string) bool {
...
// Store the movie title as a key and sum the counter by one for that movie and the score
